This is a web application project with a AirBnB like project. The web provides three restaurants for customers to order food online. Here are the summary of the project.
